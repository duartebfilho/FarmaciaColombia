...
public class CustomersController implements ActionListener, MouseListener, KeyListener {
    ...
    public void listAllCustomers() {
        ...
        // e agora vai em SystemView (source) e acrescenta a chamada no grupo controlador de clientes
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == views.btn_register_customer) {
            ...
            if (row == -1) {
                ...
                int question = JOptionPane.showConfirmDialog(null, "Em realidad quieres eliminar a este cliente?");
