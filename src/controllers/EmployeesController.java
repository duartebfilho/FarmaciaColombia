...
public class EmployeesController implements ActionListener, MouseListener, KeyListener {
    ...
    // antes de seguir, importar clases arriba
    // necesario obtener rol 
    String rol = rol_user;

    // crear DefaultTableModel uma "tabela" para iteragir con DB
    ...
    public EmployeesController(Employees employee, EmployeesDao employeeDao, SystemView views) {
        ...
        this.views.btn_register_employee.addKeyListener(this);
        ...
        // colocar label (employee) en escucha (de SystemView)
    ...
    public void actionPerformed(ActionEvent e) {
        // se operador clicou no boton registrar 
        if (e.getSource() == views.btn_register_employee) {
            // se clicou em registrar, agora ver se campos estan vacios
            if (views.txt_employee_id.getText().equals("")
                ...
                // envia dados para banco de dados e testa se ok
                if (employeeDao.registerEmployeeQuery(employee)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Ha occurido un error al registrar al empleado");
                }
            }
            ...
            if (views.txt_employee_id.getText().equals("")) {
                ...
                if (views.txt_employee_id.getText().equals("")
                    ...
                    if (employeeDao.updateEmployeeQuery(employee)){
                        ...
                        JOptionPane.showMessageDialog(null, "Ha occurido un error al modificar al empleado");
                    }
                }
            }
            ...
            if (row == -1){
                ...
                int question = JOptionPane.showConfirmDialog(null, "Em realidad quieres eliminar a este empleado?");
            ...
            if (!password.equals("") && !confirm_password.equals("")){
                // verificar si las contraseñas sean iguales
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == views.employees_table) {
            ...
            // agora move para controles dados de employee_table
            ...
            // en estos momentos algunos botones e cajas de texto deben ser deshabilitadas
            // txt_empoyee_id, txt_employee_password, btn_register_employee
            ...
            if (rol.equals("Administrador")){
                ...
                JOptionPane.showMessageDialog(null,"No tiene privilegios para acceder a esta vista");
    ...
    public void keyReleased(KeyEvent e) {
        // aqui, se escrever algo em txt_search_employee, executa metodo listAllEmployees
        // que se nada for digitado, lista tudo ou se digitar algo será filtrado naquele metodo
