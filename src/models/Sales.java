...
public class Sales {
    // criando primeiro modelo e modeloDao para SALES
    
    private int id;
    private String sale_date;
    private double total_to_pay;
    private int customer_id;
    // customer_name pegar do relacionamento com tabela customers
    private String customer_name;
    private int employee_id;
    // employee_name pegar do relacionamento com tabela employees
